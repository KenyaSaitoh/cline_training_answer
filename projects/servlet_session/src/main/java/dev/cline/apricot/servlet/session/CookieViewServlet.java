...
public class CookieViewServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < cookies.length; i++) {
            ...
            // Comment and Version methods are deprecated in Jakarta Servlet 6+
            ...
            out.println("Cookie[" + i + "] Secure ---> " + cookies[i].getSecure() + "<br />");
            out.println("Cookie[" + i + "] HttpOnly ---> " + cookies[i].isHttpOnly() + "<br />");
            out.println("<br />");
        }
        out.println("</body>");
        out.println("</html>");
